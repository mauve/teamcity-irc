...
public class Notifier implements Notificator {
    ...
    private static final Logger LOG = Logger.getInstance("IRC_NOTIFIER");
    ...
    private String formatRunningBuild(SRunningBuild srb, String state) {
    	String msg = "Build " + srb.getFullName() + " " +
    					srb.getBuildNumber() + " " + state;
	...
	private String formationTestResponsibilityEntry(
			TestNameResponsibilityEntry test1,
			TestNameResponsibilityEntry test2, SProject project, String what) {
		String msg = "Tests " + test1.getTestName().getAsString() + " and " +
						test2.getTestName().getAsString() + " in project " +
							project.getName() + " " + what;
		return msg;
	}
	...
	@Override
	public void notifyResponsibleAssigned(TestNameResponsibilityEntry test1,
			TestNameResponsibilityEntry test2, SProject project, Set<SUser> users) {
